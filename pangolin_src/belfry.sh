...
case "$1" in
    ...
    pull_sync_status)
		...
		rsync	\
			...
			-g --chown=:"${storgrp}"	\
			belfry@euler.ethz.ch::${remote_status_influenza}/sync/ \
    ...
    pull_downstream_status)
		...
		rsync	\
			...
			-p --chmod=Dg+s,ug+rw,o-rwx	\
			-g --chown=:"${storgrp}"	\
			belfry@euler.ethz.ch::${remote_status_influenza}/downstream_analysis/ \
    ...
    pull_sortsamples_status)
		...
		rsync	\
			...
			-p --chmod=Dg+s,ug+rw,o-rwx	\
			-g --chown=:"${storgrp}"	\
			belfry@euler.ethz.ch::${remote_status_influenza}/sortsamples/* \
