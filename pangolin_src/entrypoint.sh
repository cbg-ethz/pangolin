...
cp /run/secrets/id_ed25519_influenza /app/resources/config /app/resources/id_ed25519_influenza.pub /run/secrets/rsync.pass.euler /app/resources/id_ed25519_spsp_uploads.pub ~/.ssh
