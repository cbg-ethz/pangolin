...
cp /run/secrets/id_ed25519_rsv /run/secrets/id_ed25519_rsv_backups /app/resources/config /app/resources/id_ed25519_rsv.pub /app/resources/id_ed25519_rsv_backups.pub /run/secrets/rsync.pass.euler /app/resources/id_ed25519_spsp_uploads.pub ~/.ssh
