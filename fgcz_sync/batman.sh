...
scriptdir=/cluster/project/pangolin/test_automation/pangolin/pangolin_src  #on euler?
...
#                                         #recent="..."
	...
	;;
        ...
        while [[ -n $2 ]]; do
            ...
            shift  # Shift to the next parameter
        done
        ...
        if [[ "${3}" = "--recent" ]]; then
            limitlast='3 weeks ago'  # Set the time limit to 3 weeks ago
