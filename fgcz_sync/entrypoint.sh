...
cp /run/secrets/id_ed25519_fgcz_sync /run/secrets/id_ed25519_wisedb /run/secrets/id_ed25519_wisedb_backups /app/resources/config /app/resources/id_ed25519_fgcz_sync.pub /run/secrets/rsync.pass.euler ~/.ssh
